...
public class Assignment4 {
	...
	public void login() throws InterruptedException {
		...
		driver.findElement(By.className("email")).sendKeys("ayanakash936@gmail.com");
		driver.findElement(By.className("password")).sendKeys("Epsilon@123");
	...
	public void GoToShoppingCart() {
		...
		String total_val = driver.findElement(By.xpath("//span[@class='product-price'][normalize-space()='3600.00']"))
				.getText();
